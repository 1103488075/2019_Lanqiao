...
void DS1302_Init()
{
    ...
    Ds1302_Single_Byte_Write(ds1302_sec_addr,0x50);  //秒
    Ds1302_Single_Byte_Write(ds1302_min_addr,0x59);  //分 27
    Ds1302_Single_Byte_Write(ds1302_hr_addr,0x23);  //时  09
    ...
    Ds1302_Single_Byte_Write(0x8e,0x80); //关闭写保护
}
