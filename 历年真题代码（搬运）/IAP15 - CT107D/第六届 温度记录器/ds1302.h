...
//#include<regx52.h> // 可忽略，
#include<intrins.h>
/********************************************************************/
sbit SCK=P1^7;
sbit SDA_ds=P2^3; //这里的SDA定义 会与 iic.h里的定义冲突
sbit RST=P1^3;
/********************************************************************/
/*复位脚*/
...
/*双向数据*/
#define SDA_CLR	SDA_ds=0	/*电平置低*/
#define SDA_SET	SDA_ds=1	/*电平置高*/
#define SDA_R	SDA_ds	/*电平读取*/
/*时钟信号*/
...
/********************************************************************/
/*从DS1302单字节读出一字节数据*/
extern unsigned char Ds1302_Single_Byte_Read(unsigned char addr);    //读时间的结果为BCD码，对16取余
/********************************************************************
/* */
